<template>
  <div class="deleverage-popup">
    ...
    <button class="dont-show-btn" @click="dontShowAgain">
      Don&#39;t show again
    </button>
  </div>
</template>
...
export default {
  data() {
    return {
      docsLink: "https://docs.nereus.finance/",
    };
  },
  methods: {
    closePopup() {
    ...
    dontShowAgain() {
      localStorage.setItem("neverShowDeleveragePopup", true);
      this.closePopup();
    },
  },
};
